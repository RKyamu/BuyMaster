...
import 'package:flutter_buymaster_user_app/view/screen/notification/widget/notification_dialog.dart';
...
class NotificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Provider.of<SplashProvider>(context, listen: false).setSeenNotification();
    Provider.of<NotificationProvider>(context, listen: false)
        .initNotificationList(context);

    print("notification screewn");
