...
import 'package:flutter_buymaster_user_app/helper/date_converter.dart';
import 'package:flutter_buymaster_user_app/provider/localization_provider.dart';
import 'package:flutter_buymaster_user_app/view/basewidget/shimmer_loading.dart';
import 'package:flutter_buymaster_user_app/view/screen/dashboard/dashboard_screen.dart';
import 'package:flutter_buymaster_user_app/view/screen/order/widget/cal_chat_widget.dart';
import 'package:flutter_buymaster_user_app/view/screen/order/widget/cancel_and_support_center.dart';
import 'package:flutter_buymaster_user_app/view/screen/order/widget/ordered_product_list.dart';
import 'package:flutter_buymaster_user_app/view/screen/order/widget/payment_info.dart';
import 'package:flutter_buymaster_user_app/view/screen/order/widget/seller_section.dart';
import 'package:flutter_buymaster_user_app/view/screen/order/widget/shipping_info.dart';
...
import 'package:flutter_buymaster_user_app/view/basewidget/amount_widget.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  void _loadData(BuildContext context) async {
    print("print - order_details_id ${widget.orderId}");
  ...
  void dispose() {
    ...
    Provider.of<OrderProvider>(context, listen: false).setOrderDetails();
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    print("print - Order details screen");
    return WillPopScope(
      onWillPop: () async {
        dispose();
            ...
            Expanded(
              child: Consumer<OrderProvider>(
                builder: (context, order, child) {
                  print("print - order details list - ${order.orderDetails}");
                  double _order = 0;
                  double _discount = 0;
                  double eeDiscount = 0;
                  double _tax = 0;
