                ...
                child: Consumer<OrderProvider>(
                  builder: (context, order, child) {
                    ...
                    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      AmountWidget(title: getTranslated('DISCOUNT', context), haveMinus: true, amount: PriceConverter.convertPrice(context, widget.discount)),
                      AmountWidget(title: getTranslated('coupon_voucher', context), haveMinus: true, amount: PriceConverter.convertPrice(context, _couponDiscount)),
