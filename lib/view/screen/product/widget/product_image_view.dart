...
import 'package:flutter_buymaster_user_app/data/model/response/product_details_model.dart'
    as pd;
...
import 'package:flutter_buymaster_user_app/view/screen/product/product_image_screen.dart';
import 'package:flutter_buymaster_user_app/view/screen/product/widget/favourite_button.dart';
                    ...
                    Positioned(
                      ...
                      child: Column(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              var product = Provider.of<ProductDetailsProvider>(
                                context,
                                listen: false,
                              );
                              var link = product.sharableLink;
                              if (link != null) {
                                Share.share(
                                    "$link/${product.productDetailsModel.id}");
                              }
                            },
                            child: Card(
                              elevation: 2,
