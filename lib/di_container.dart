...
import 'package:flutter_buymaster_user_app/data/repository/auth_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/banner_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/brand_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/cart_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/category_repo.dart';
...
import 'package:flutter_buymaster_user_app/data/repository/featured_deal_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/flash_deal_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/location_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/notification_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/onboarding_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/product_details_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/order_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/product_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/profile_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/search_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/seller_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/splash_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/support_ticket_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/top_seller_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/wallet_transaction_repo.dart';
import 'package:flutter_buymaster_user_app/data/repository/wishlist_repo.dart';
import 'package:flutter_buymaster_user_app/helper/network_info.dart';
...
import 'package:flutter_buymaster_user_app/provider/chat_provider.dart';
import 'package:flutter_buymaster_user_app/provider/coupon_provider.dart';
import 'package:flutter_buymaster_user_app/provider/facebook_login_provider.dart';
...
import 'package:flutter_buymaster_user_app/provider/google_sign_in_provider.dart';
import 'package:flutter_buymaster_user_app/provider/home_category_product_provider.dart';
import 'package:flutter_buymaster_user_app/provider/localization_provider.dart';
import 'package:flutter_buymaster_user_app/provider/location_provider.dart';
import 'package:flutter_buymaster_user_app/provider/notification_provider.dart';
import 'package:flutter_buymaster_user_app/provider/onboarding_provider.dart';
import 'package:flutter_buymaster_user_app/provider/product_details_provider.dart';
import 'package:flutter_buymaster_user_app/provider/order_provider.dart';
...
import 'package:flutter_buymaster_user_app/provider/search_provider.dart';
import 'package:flutter_buymaster_user_app/provider/seller_provider.dart';
import 'package:flutter_buymaster_user_app/provider/splash_provider.dart';
import 'package:flutter_buymaster_user_app/provider/support_ticket_provider.dart';
...
import 'package:flutter_buymaster_user_app/provider/wallet_transaction_provider.dart';
import 'package:flutter_buymaster_user_app/provider/wishlist_provider.dart';
...
bool get intialized => _initialized;
